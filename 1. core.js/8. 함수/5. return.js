...
function add(n1, n2) {
    return n1 + n2;      // 값을 유지해줌 return으로 보내주기 때문에
    console.log('안녕!');
}
...
// 반환값(return) : 함수 호출부로 함수의 결과값을 가져다주는 것
var r1 = add(5, 7);
console.log(r1);
...
// 변수에 저장할 수 없고, 다른 함수의 인수로도 사용 불가능
var r3 = multi(3, 5);
console.log(`r3: ${r3}`);
...
// 함수의 리턴값은 언제나 하나!
// 그런데 2개의 정수를 전달받아서, +-*/의 4가지 결과를 리턴받고 싶다????

function operateAll(n1, n2) {
    // return [n1 + n2, n1 - n2, n1 * n2, n1 / n2];  // 배열 한개에 다담아~~
    return {
        plus: add(n1, n2),
        minus: n1 - n2,
        multi: n1 * n2,
